...
public class Settings
{
	...
	public static final Integer			SERVICEPACK_CACHE_INTERVAL		= getInteger("sds.servicepacks.cache.interval", 10);
	public static final Integer			RELEASES_CACHE_INTERVAL			= getInteger("sds.releases.cache.interval", 10);
	public static final Integer			LANGUAGEPACKS_CACHE_INTERVAL	= getInteger("sds.languagepacks.cache.interval", 10);
	public static final Integer			PRODUCTS_CACHE_INTERVAL			= getInteger("sds.products.cache.interval", 10);

	public static final Integer			ARCHIVE_MAX_RETAIN_PERIOD		= getInteger("sds.archive.max.retain.period", 42);
	public static final Integer			ARCHIVE_MIN_RETAIN_PERIOD		= getInteger("sds.archive.min.retain.period", 7);
	public static final Long			ARCHIVE_MIN_FREE_SPACE			= getLong("sds.archive.min.free.space", 1000000000);
	...
	private static Integer getInteger(final String property, int defaultValue)
	{
		return Play.application().configuration().getInt(property, defaultValue);
	}

	private static Long getLong(final String property, long defaultValue)
	{
		return Play.application().configuration().getLong(property, defaultValue);
	}
