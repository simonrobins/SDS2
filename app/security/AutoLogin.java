...
public class AutoLogin
{
	...
	public boolean validateMd5(final String secret, final String id, final String expires, final String md5)
	{
		return validateMd5(secret, id, expires, null, md5);
	}

	public boolean validateMd5(final String secret, final String id, final String expires, @Nullable final String access, final String md5)
	{
		...
		// Only cache the MD5 if it came from the CODA Portal - i.e. the access level is null
		if(access == null)
		{
	...
	public String generateMd5(final String secret, final String id, final String expires, @Nullable final String access)
	{
